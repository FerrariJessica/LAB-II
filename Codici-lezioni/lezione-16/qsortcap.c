/* *********************************************************
 * Esempio di uso di qsort per ordinare array di capitali
 * ********************************************************* */
...
int confronta_capitali_nome(capitale **a, capitale **b)
{
  capitale *ca = *a;
  capitale *cb = *b;
...
int main(int argc, char *argv[])
{
  ...
  // stampo array
  puts("--- qsort in base alla latitudine eseguito ---\n");
  // stampo array
  for(int i=0;i<n;i++)
    capitale_stampa(a[i],stdout);
  puts(""); // a capo 
  ...
  // come spiegato a lezione per l'ultimo argomento ci vuole il casting  
  qsort(a,n,sizeof(capitale *), 
        (__compar_fn_t) &confronta_capitali_nome); 
  
  puts("--- qsort in base al nome eseguito ---\n");
  // stampo array
  for(int i=0;i<n;i++)
    capitale_stampa(a[i],stdout);
  puts(""); // a capo 
